                ...
                <div className="grid md:grid-cols-4 gap-16 mb-20">
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <div className="flex gap-4">
                            ...
                            <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-yellow hover:text-coffee-brown transition-colors">
                            ...
                            <a href="https://wa.me/573171503273" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-yellow hover:text-coffee-brown transition-colors">
